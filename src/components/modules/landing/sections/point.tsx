...
export default function PointSection() {
  return (
    <section className="mt-52 mb-52">
      <Subtitle>Game-Changer For Your Investment</Subtitle>
      <ul className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-12 mt-7">
        <li className="flex justify-center flex-col items-center gap-6">
          <MarketIcon size={62} />
          <p className="text-lg sm:text-xl md:text-2xl font-primary text-center">
            Top-selling NFTs
          </p>
        </li>
        <li className="flex justify-center flex-col items-center gap-6">
